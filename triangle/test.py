...
class Test(unittest.TestCase):
    ...
    def test_checkTriangle_wrongInput_3(self):
        self.assertEqual("Fail Input", triangle.detect_triangle("hello", 4, 5))
        
    def test_checkTriangle_Khongphaitamgiac(self):
        self.assertEqual("khong phai tam giac", triangle.detect_triangle(1, 5, 10))
        
    def test_checkTriangle_Tamgiacthuong(self):
        self.assertEqual("tam giac thuong", triangle.detect_triangle(3, 5, 6))
        
    def test_checkTriangle_Tamgiaccan(self):
        self.assertEqual("tam giac can", triangle.detect_triangle(3, 3, 5))
    ...
    def test_checkTriangle_Tamgiacdeu(self):
        self.assertEqual("tam giac deu", triangle.detect_triangle(5, 5, 5))
